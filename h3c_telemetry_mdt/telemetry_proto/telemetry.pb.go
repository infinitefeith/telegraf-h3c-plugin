...
const (
	Telemetry_Encoding_JSON Telemetry_Encoding = 0
	Telemetry_Encoding_GPB  Telemetry_Encoding = 1
)
...
type Telemetry struct {
	...
	ProducerName        string             `protobuf:"bytes,1,opt,name=producer_name,json=producerName,proto3" json:"producer_name,omitempty"` //Device producer_name
	NodeIdStr           string             `protobuf:"bytes,2,opt,name=node_id_str,json=nodeIdStr,proto3" json:"node_id_str,omitempty"`        //Device name
	ProductName         string             `protobuf:"bytes,3,opt,name=product_name,json=productName,proto3" json:"product_name,omitempty"`
	SubscriptionIdStr   string             `protobuf:"bytes,15,opt,name=subscription_id_str,json=subscriptionIdStr,proto3" json:"subscription_id_str,omitempty"`
	SensorPath          string             `protobuf:"bytes,16,opt,name=sensor_path,json=sensorPath,proto3" json:"sensor_path,omitempty"`
	CollectionId        uint64             `protobuf:"varint,17,opt,name=collection_id,json=collectionId,proto3" json:"collection_id,omitempty"` //标识采样轮次
	CollectionStartTime uint64             `protobuf:"varint,18,opt,name=collection_start_time,json=collectionStartTime,proto3" json:"collection_start_time,omitempty"`
	MsgTimestamp        uint64             `protobuf:"varint,19,opt,name=msg_timestamp,json=msgTimestamp,proto3" json:"msg_timestamp,omitempty"`
	CollectionEndTime   uint64             `protobuf:"varint,20,opt,name=collection_end_time,json=collectionEndTime,proto3" json:"collection_end_time,omitempty"`
	CurrentPeriod       uint32             `protobuf:"varint,21,opt,name=current_period,json=currentPeriod,proto3" json:"current_period,omitempty"`
	ExceptDesc          string             `protobuf:"bytes,22,opt,name=except_desc,json=exceptDesc,proto3" json:"except_desc,omitempty"`
	Encoding            Telemetry_Encoding `protobuf:"varint,23,opt,name=encoding,proto3,enum=telemetry.Telemetry_Encoding" json:"encoding,omitempty"`
	DataStr             string             `protobuf:"bytes,24,opt,name=data_str,json=dataStr,proto3" json:"data_str,omitempty"`
	DataGpb             *TelemetryGPBTable `protobuf:"bytes,25,opt,name=data_gpb,json=dataGpb,proto3" json:"data_gpb,omitempty"`
}
...
func (x *Telemetry) GetProducerName() string {
	if x != nil {
...
func (x *Telemetry) GetEncoding() Telemetry_Encoding {
	...
	return Telemetry_Encoding_JSON
}
...
var file_telemetry_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x09, 0x74, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x22, 0xfa, 0x04, 0x0a,
	0x09, 0x54, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x12, 0x23, 0x0a, 0x0d, 0x70, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x65, 0x72, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0c, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12,
	0x1e, 0x0a, 0x0b, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x69, 0x64, 0x5f, 0x73, 0x74, 0x72, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6e, 0x6f, 0x64, 0x65, 0x49, 0x64, 0x53, 0x74, 0x72, 0x12,
	...
	0x6d, 0x65, 0x12, 0x2e, 0x0a, 0x13, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x5f, 0x73, 0x74, 0x72, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x11, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x53,
	0x74, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x5f, 0x70, 0x61, 0x74,
	0x68, 0x18, 0x10, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x73, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x50,
	0x61, 0x74, 0x68, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x69, 0x64, 0x18, 0x11, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x63, 0x6f, 0x6c, 0x6c,
	...
	,
	...
	0x18, 0x18, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x64, 0x61, 0x74, 0x61, 0x53, 0x74, 0x72, 0x12,
	0x37, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x67, 0x70, 0x62, 0x18, 0x19, 0x20, 0x01, 0x28,
	...
	0x07, 0x64, 0x61, 0x74, 0x61, 0x47, 0x70, 0x62, 0x22, 0x2f, 0x0a, 0x08, 0x45, 0x6e, 0x63, 0x6f,
	0x64, 0x69, 0x6e, 0x67, 0x12, 0x11, 0x0a, 0x0d, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67,
	0x5f, 0x4a, 0x53, 0x4f, 0x4e, 0x10, 0x00, 0x12, 0x10, 0x0a, 0x0c, 0x45, 0x6e, 0x63, 0x6f, 0x64,
	0x69, 0x6e, 0x67, 0x5f, 0x47, 0x50, 0x42, 0x10, 0x01, 0x22, 0x41, 0x0a, 0x11, 0x54, 0x65, 0x6c,
	0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x47, 0x50, 0x42, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x2c,
	0x0a, 0x03, 0x72, 0x6f, 0x77, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x74, 0x65,
	0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x2e, 0x54, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72,
	...
	0x28, 0x0c, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x42, 0x0e, 0x5a, 0x0c, 0x2e,
	0x2f, 0x3b, 0x74, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_telemetry_proto_depIdxs = []int32{
	0, // 0: telemetry.Telemetry.encoding:type_name -> telemetry.Telemetry.Encoding
